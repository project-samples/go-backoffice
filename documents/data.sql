...
insert into modules (moduleid, modulename, status,path, resourcekey, icon, "sequence", parent, createdby, createdat, updatedby, updatedat)values('article', 'Article', 'A', '/article', 'article', 'article', 4, '', NULL, NULL, NULL, NULL);
insert into modules (moduleid, modulename, status,path, resourcekey, icon, "sequence", parent, createdby, createdat, updatedby, updatedat)values('entity', 'Entities', 'A', '/entities', 'entity', 'data_object', 4, '', NULL, NULL, NULL, NULL);
insert into modules (moduleid, modulename, status,path, resourcekey, icon, "sequence", parent, createdby, createdat, updatedby, updatedat)values('company', 'Company', 'A', '/companies', 'company', 'apartment', 4, '', NULL, NULL, NULL, NULL);
insert into modules (moduleid, modulename, status,path, resourcekey, icon, "sequence", parent, createdby, createdat, updatedby, updatedat)values('question', 'Question', 'A', '/question', 'question', 'quiz', 4, '', NULL, NULL, NULL, NULL);
insert into modules (moduleid, modulename, status,path, resourcekey, icon, "sequence", parent, createdby, createdat, updatedby, updatedat)values('test', 'Test', 'A', '/test', 'test', 'feed', 4, '', NULL, NULL, NULL, NULL);
insert into modules (moduleid, modulename, status,path, resourcekey, icon, "sequence", parent, createdby, createdat, updatedby, updatedat)values('ticket', 'Ticket Support', 'A', '/ticket', 'ticket', 'support_agent', 4, '', NULL, NULL, NULL, NULL);
...
INSERT INTO modules (moduleid, modulename, status, "path", resourcekey, icon, "sequence", parent, createdby, createdat, updatedby, updatedat)values('product', 'Product', 'A', '/products', 'product', 'production_quantity_limits', 4, '', NULL, NULL, NULL, NULL);
...
insert into companies (companyid,companyname,email,imageurl,status,phone) values ('00001','gareth.bale.corp','gareth.bale@gmail.com','https://uploads.wikimedia.org/wikipedia/commons/thumb/4/41/Liver-RM_%282%29_%28cropped%29.jpg/440px-Liver-RM_%282%29_%28cropped%29.jpg','A','0987654321');
insert into companies (companyid,companyname,email,imageurl,status,phone) values ('00003','james.rodriguez.corp','james.rodriguez@gmail.com','https://uploads.wikimedia.org/wikipedia/commons/thumb/7/79/James_Rodriguez_2018.jpg/440px-James_Rodriguez_2018.jpg','A','0987654321');
insert into companies (companyid,companyname,email,imageurl,status,phone) values ('00004','zinedine.zidane.corp','zinedine.zidane@gmail.com','https://uploads.wikimedia.org/wikipedia/commons/f/f3/Zinedine_Zidane_by_Tasnim_03.jpg','A','0987654321');
insert into companies (companyid,companyname,email,imageurl,status,phone) values ('00005','kaka.corp','kaka@gmail.com','https://uploads.wikimedia.org/wikipedia/commons/thumb/6/6d/Kak%C3%A1_visited_Stadium_St._Petersburg.jpg/500px-Kak%C3%A1_visited_Stadium_St._Petersburg.jpg','A','0987654321');
...
-- ----------------------------
insert into questions (id, title, body, mixed, tags, categoryid, "options", createdby, createdat, updatedby, updatedat, answers)values('n2N0UM6tM', 'test2', 'You want to identify which tasks in the planned learning activity incorporate the use of the computer lab.
...
insert into questions (id, title, body, mixed, tags, categoryid, "options", createdby, createdat, updatedby, updatedat, answers)values('mbdiwMwap', 'aaaa', 'aaaaa', false, NULL, 'TEST_01', NULL, NULL, NULL, NULL, NULL, '{"{\"body\": \"Yes\", \"correct\": true}","{\"body\": \"No\", \"correct\": false}"}');
insert into questions (id, title, body, mixed, tags, categoryid, "options", createdby, createdat, updatedby, updatedat, answers)values('od19Lp6ap', 'rwerwer', 'sdfsdfsd', false, '{dfasdfsdf,sdfsdfsdf,sdfsdfdsf}', 'TEST_02', NULL, NULL, NULL, NULL, NULL, '{"{\"body\": \"sdfsdfsdf\", \"correct\": true}","{\"body\": \"sdfsdfsdfsdf\", \"correct\": false}"}');
insert into questions (id, title, body, mixed, tags, categoryid, "options", createdby, createdat, updatedby, updatedat, answers)values('f4Z9KQ_aM', 'adsdfsdfsdf', 'What will happen after the brunch?', false, NULL, 'TEST_02', '{"The people will be served drinks.","An artist will show his drawings.","The guests will introduce themselves.","A poet will read a poem."}', NULL, '2023-06-15 13:38:23.570', NULL, '2023-06-15 13:37:53.430', '{"{\"body\": \"asdfssdf\", \"correct\": false}","{\"body\": \"sdfdsfsdfsdf\", \"correct\": false}"}');
insert into questions (id, title, body, mixed, tags, categoryid, "options", createdby, createdat, updatedby, updatedat, answers)values('Io2cK1Vtp', '', 'What do guests get to take home?', false, NULL, 'TEST_02', '{Lunch,"A book of mythology","A collection of poems","A painting"}', NULL, '2023-06-15 13:38:23.570', NULL, '2023-06-15 13:37:53.430', NULL);
insert into questions (id, title, body, mixed, tags, categoryid, "options", createdby, createdat, updatedby, updatedat, answers)values('QTjMlQ_ap', 'test2', 'You want to identify which tasks in the planned learning activity incorporate the use of the computer lab.
Which task should you identify?
...
insert into questions (id, title, body, mixed, tags, categoryid, "options", createdby, createdat, updatedby, updatedat, answers)values('VFfZX1_ap', '', 'You teach a class of 20 students. Your classroom contains six computers.
...
insert into questions (id, title, body, mixed, tags, categoryid, "options", createdby, createdat, updatedby, updatedat, answers)values('tP8GXQVaM', '', 'What are the man and woman mainly discussing?', false, NULL, 'TEST_02', '{"A vacation","A budget","A company policy","A conference"}', NULL, '2023-06-15 13:38:23.570', NULL, '2023-06-15 13:37:53.430', NULL);
insert into questions (id, title, body, mixed, tags, categoryid, "options", createdby, createdat, updatedby, updatedat, answers)values('NQL_XQ_tp', '', 'How is the woman traveling?', false, NULL, 'TEST_02', '{"By plane","By bus","By taxi","By car"}', NULL, '2023-06-15 13:38:23.570', NULL, '2023-06-15 13:37:53.430', NULL);
insert into questions (id, title, body, mixed, tags, categoryid, "options", createdby, createdat, updatedby, updatedat, answers)values('9i-QvQ_tp', '', 'Why aren''t the man and woman going together?', false, NULL, 'TEST_02', '{"The woman needs to arrive earlier.","The man has to work overtime.","The woman dislikes air travel.","The man has to go to the bank first."}', NULL, '2023-06-15 13:38:23.570', NULL, '2023-06-15 13:37:53.430', NULL);
insert into questions (id, title, body, mixed, tags, categoryid, "options", createdby, createdat, updatedby, updatedat, answers)values('VzkRv1Vtp', '', 'What does the man have to do today?', false, NULL, 'TEST_02', '{"Visit his lawyer","Get a massage","Go to the doctor.","Make an appointment."}', NULL, '2023-06-15 13:38:23.570', NULL, '2023-06-15 13:37:53.430', NULL);
insert into questions (id, title, body, mixed, tags, categoryid, "options", createdby, createdat, updatedby, updatedat, answers)values('T_xCX1_ap', '', 'What can be inferred from the conversation?', false, NULL, 'TEST_02', '{"The woman is the man''s receptionist.","The lawyer works in the same building.","The woman has no deadlines today.","The man and woman have a meeting this afternoon."}', NULL, '2023-06-15 13:38:23.570', NULL, '2023-06-15 13:37:53.430', NULL);
insert into questions (id, title, body, mixed, tags, categoryid, "options", createdby, createdat, updatedby, updatedat, answers)values('VWuoK1_tM', '', 'What does the woman offer to do for the man?', false, NULL, 'TEST_02', '{"Answer his phone","Call his lawyer","Pick up the newspaper","Take notes at the meeting"}', NULL, '2023-06-15 13:38:23.570', NULL, '2023-06-15 13:37:53.430', NULL);
insert into questions (id, title, body, mixed, tags, categoryid, "options", createdby, createdat, updatedby, updatedat, answers)values('aZOHd1Vtp', '', 'What should the passengers do before exiting the ship?', false, NULL, 'TEST_02', '{"Welcome the visitors","Check the time","Collect their personal items","Take a picture"}', NULL, '2023-06-15 13:38:23.570', NULL, '2023-06-15 13:37:53.430', NULL);
insert into questions (id, title, body, mixed, tags, categoryid, "options", createdby, createdat, updatedby, updatedat, answers)values('S6J0KQVaM', '', 'What does the speaker imply?', false, NULL, 'TEST_02', '{"The water was rough.","The weather was poor yesterday.","The tour went faster than usual.","There is only one way to exit."}', NULL, '2023-06-15 13:38:23.570', NULL, '2023-06-15 13:37:53.430', NULL);
insert into questions (id, title, body, mixed, tags, categoryid, "options", createdby, createdat, updatedby, updatedat, answers)values('cJWfK1_ap', '', 'What will happen in five minutes?', false, NULL, 'TEST_02', '{"The ship will arrive at the dock.","The passengers will go shopping.","The passengers will take photos of the ship.","The market will open."}', NULL, '2023-06-15 13:38:23.570', NULL, '2023-06-15 13:37:53.430', NULL);
insert into questions (id, title, body, mixed, tags, categoryid, "options", createdby, createdat, updatedby, updatedat, answers)values('f_XaK1VtM', '', 'How often does this event take place?', false, NULL, 'TEST_02', '{Monthly,"Four times a year","Once a year","Every four years"}', NULL, '2023-06-15 13:38:23.570', NULL, '2023-06-15 13:37:53.430', NULL);
insert into questions (id, title, body, mixed, tags, categoryid, "options", createdby, createdat, updatedby, updatedat, answers)values('UkkSd1_tM', '', 'Where would you hear this type of talk?', false, NULL, 'TEST_02', '{"In an airport","At a bus station","On a telephone","On television"}', NULL, '2023-06-15 13:38:23.570', NULL, '2023-06-15 13:37:53.430', NULL);
insert into questions (id, title, body, mixed, tags, categoryid, "options", createdby, createdat, updatedby, updatedat, answers)values('cDiEdQ_tp', '', 'Who should visit the website?', false, NULL, 'TEST_02', '{"Staff members of Speedy Reservations","Callers looking for special schedules","Callers looking for staff members","People looking for fight times"}', NULL, '2023-06-15 13:38:23.570', NULL, '2023-06-15 13:37:53.430', NULL);
insert into questions (id, title, body, mixed, tags, categoryid, "options", createdby, createdat, updatedby, updatedat, answers)values('hs2iK1VtM', '', 'What is the quickest way to get connected to a representative?', false, NULL, 'TEST_02', '{"Hang up and call again","Call back later"," Wait patiently","Call a different number"}', NULL, '2023-06-15 13:38:23.570', NULL, '2023-06-15 13:37:53.430', NULL);
insert into questions (id, title, body, mixed, tags, categoryid, "options", createdby, createdat, updatedby, updatedat, answers)values('Lk7LKQ_tp', '', 'Did you have to wait very long?', false, '{part2}', 'TEST_02', '{"No more than an hour.","I hate long line-ups.","I''ve gained twenty pounds."}', NULL, '2023-06-15 13:38:23.570', NULL, '2023-06-15 13:37:53.430', NULL);
insert into questions (id, title, body, mixed, tags, categoryid, "options", createdby, createdat, updatedby, updatedat, answers)values('IzqAd1Vap', '', 'Do you think the boss will take us out for lunch today?', false, '{part2}', 'TEST_02', '{"I had a hamburger and fries.","He''s probably too busy today.","I didn''t take the bus."}', NULL, '2023-06-15 13:38:23.570', NULL, '2023-06-15 13:37:53.430', NULL);
insert into questions (id, title, body, mixed, tags, categoryid, "options", createdby, createdat, updatedby, updatedat, answers)values('_1RQ9RVap', '', 'An listed entity under FATCA, is technically classified as', false, NULL, 'FATCA_Mock_Test', '{"Active NFE","Account Holder","Active NFFE",nominee}', NULL, '2023-06-15 13:38:23.570', NULL, '2023-06-15 13:37:53.430', NULL);
insert into questions (id, title, body, mixed, tags, categoryid, "options", createdby, createdat, updatedby, updatedat, answers)values('owb_KQ_tM', '', 'Did you fax the letter to the client?', false, '{part2}', 'TEST_02', '{"I''ll type it after lunch.","No, I sent it by email.","I collected some important facts."}', NULL, '2023-06-15 13:38:23.570', NULL, '2023-06-15 13:37:53.430', NULL);
insert into questions (id, title, body, mixed, tags, categoryid, "options", createdby, createdat, updatedby, updatedat, answers)values('7t9IrRVap', '', 'What is the last step to be followed to determine whether a person is a RFI and thus has reporting obligations', false, NULL, 'FATCA_Mock_Test', '{"Is the Entity a Financial Institution?","Is it an Entity?","Is the Financial Institution in India?","Is the Financial Institution a Non-Reporting Financial Institution?"}', NULL, '2023-06-15 13:38:23.570', NULL, '2023-06-15 13:37:53.430', NULL);
insert into questions (id, title, body, mixed, tags, categoryid, "options", createdby, createdat, updatedby, updatedat, answers)values('dlbV9RVtp', '', 'An Active NFE should have', false, NULL, 'FATCA_Mock_Test', '{"if the entity during the last year: More than (or equal to) 25% of the entity’s gross income consisted of Active Income","if the entity during the last year: More than (or equal to) 50% of the entity’s gross income consisted of Active Income","if the entity during the last year: More than (or equal to) 50% of the entity’s gross income consisted of Active Income","if the entity during the last year: More than (or equal to) 75% of the entity’s gross income consisted of Active Income"}', NULL, '2023-06-15 13:38:23.570', NULL, '2023-06-15 13:37:53.430', NULL);
insert into questions (id, title, body, mixed, tags, categoryid, "options", createdby, createdat, updatedby, updatedat, answers)values('OZdm9R_aM', '', 'Under FATCA, each country entered into a separate bilateral intergovernmental agreement with the United States and what objective was achieved', false, NULL, 'FATCA_Mock_Test', '{"The local financial institutions complies with FATCA reporting standards  and will not breach local data protection laws ","Financial institutions in complying with FATCA, will not breach local data protection laws only","None of these","The local financial institutions complies with FATCA reporting standards only"}', NULL, '2023-06-15 13:38:23.570', NULL, '2023-06-15 13:37:53.430', NULL);
insert into questions (id, title, body, mixed, tags, categoryid, "options", createdby, createdat, updatedby, updatedat, answers)values('csVonL_tp', '', 'Which of the following is an exempt beneficial owner', false, NULL, 'FATCA_Mock_Test', '{"All of these","Any International Organisation or any wholly owned agency or instrumentality thereof","Any Foreign Central Bank of Issue","Any Foreign Government, any political subdivision of a Foreign Government, or any wholly owned agency or instrumentality of any one or more of the foregoing"}', NULL, '2023-06-15 13:38:23.570', NULL, '2023-06-15 13:37:53.430', NULL);
...
INSERT INTO tests(testid, title, effectivedate, questions, tags, categoryid, createdby, createdat, updatedby, updatedat)values('32uPgd6aM', 'Test 2', '2023-06-30 07:39:00.000', '{}', NULL, 'Test_02', NULL, NULL, NULL, NULL);
INSERT INTO tests(testid, title, effectivedate, questions, tags, categoryid, createdby, createdat, updatedby, updatedat)values('cQeB3YwaM', 'Test 3', '2023-06-30 17:33:00.000', '{"QTjMlQ_ap","NQL_XQ_tp"}', '{"asd"}', 'Test_02', NULL, NULL, NULL, NULL);
INSERT INTO tests(testid, title, effectivedate, questions, tags, categoryid, createdby, createdat, updatedby, updatedat)values('GzP3EYwap', 'Test 4', '2023-06-22 01:12:00.000', '{}', '{"sdfsdfsdfsdf"}', 'Test_01', NULL, NULL, NULL, NULL);
INSERT INTO tests(testid, title, effectivedate, questions, tags, categoryid, createdby, createdat, updatedby, updatedat)values('uYDyiY6tp', 'Test 1', '2023-07-26 21:00:00.000', '{}', NULL, 'Test_01', NULL, NULL, NULL, NULL);
...
INSERT INTO tickets(id, title, body, categoryid, requestor, requested_at, approver, approved_at, assignee, completed_at, status, attachments)values('s319KmVtM', '[Bug] IssueLabelBot no longer works ', 'Describe the bug
...
INSERT INTO tickets(id, title, body, categoryid, requestor, requested_at, approver, approved_at, assignee, completed_at, status, attachments)values('gjuIgMwtp', 'Markdown syntax checker / parser before ', 'What is the current behavior?
...
VALUES (
           'iTJWdm_aM',
           'Guidelines too opinionated about squashi',
           'This is a sample ticket description.',
           '4',
           'john',
           '2023-06-14 10:30:00.000',
           'approver123',
           '2023-06-14 11:00:00.000',
           'assignee456',
           '2023-06-14 12:00:00.000',
           'O',
           ARRAY[
               '{"url": "https://storage.googleapis.com/go-firestore-rest-api.appspot.com/sub/vEOmOqwaM_nice_beach.jpg", "type": "image", "fileName": "vEOmOqwaM_nice_beach.jpg"}'::jsonb,
           '{"url": "https://storage.googleapis.com/go-firestore-rest-api.appspot.com/sub/Bq0Ybuwtp_nice_beach.jpg", "type": "image", "fileName": "Bq0Ybuwtp_nice_beach.jpg", "originalFileName": "nice_beach.jpg"}'::jsonb,
           '{"url": "https://storage.googleapis.com/go-firestore-rest-api.appspot.com/sub/k9ptbqwaM_nice_beach.jpg", "type": "image", "fileName": "k9ptbqwaM_nice_beach.jpg", "originalFileName": "nice_beach.jpg"}'::jsonb,
           '{"url": "https://storage.googleapis.com/go-firestore-rest-api.appspot.com/sub/28Sgsu6tp_nice_beach.jpg", "type": "image", "fileName": "28Sgsu6tp_nice_beach.jpg", "originalFileName": "nice_beach.jpg"}'::jsonb,
           '{"url": "https://storage.googleapis.com/go-firestore-rest-api.appspot.com/sub/UI7Sdq6aM_nice_beach.jpg", "type": "image", "fileName": "UI7Sdq6aM_nice_beach.jpg", "originalFileName": "nice_beach.jpg"}'::jsonb,
           '{"url": "https://storage.googleapis.com/go-firestore-rest-api.appspot.com/sub/D9dBLvwtM_nice_beach.jpg", "type": "image", "fileName": "D9dBLvwtM_nice_beach.jpg", "originalFileName": "nice_beach.jpg"}'::jsonb,
           '{"url": "https://storage.googleapis.com/go-firestore-rest-api.appspot.com/sub/h80RrdwtM_nice_beach.jpg", "type": "image", "fileName": "h80RrdwtM_nice_beach.jpg", "originalFileName": "nice_beach.jpg"}'::jsonb,
           '{"url": "https://storage.googleapis.com/go-firestore-rest-api.appspot.com/sub/QiwNYBQaM_file_example_XLS_10.xls", "type": "application", "fileName": "QiwNYBQaM_file_example_XLS_10.xls", "originalFileName": "file_example_XLS_10.xls"}'::jsonb,
           '{"url": "https://storage.googleapis.com/go-firestore-rest-api.appspot.com/sub/FRX8toQap_file_example_XLS_10.xls", "size": 8704, "type": "application/vnd.ms-excel", "fileName": "FRX8toQap_file_example_XLS_10.xls", "originalFileName": "file_example_XLS_10.xls"}'::jsonb
  ]::jsonb[]
       );
