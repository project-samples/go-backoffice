...
type Ticket struct {
	...
	RequestedAt *time.Time `mapstructure:"requested_at" json:"requestedAt,omitempty" gorm:"column:requested_at" bson:"requestedAt,omitempty" dynamodbav:"requestedAt,omitempty" firestore:"requestedAt,omitempty" avro:"requestedAt"`
	Approver    *string    `mapstructure:"approver" json:"approver,omitempty" gorm:"column:approver" bson:"approver,omitempty" dynamodbav:"approver,omitempty" firestore:"approver,omitempty" avro:"approver" validate:"omitempty,max=40"`
	ApprovedAt  *time.Time `mapstructure:"approved_at" json:"approvedAt,omitempty" gorm:"column:approved_at" bson:"ApprovedAt,omitempty" dynamodbav:"approvedAt,omitempty" firestore:"approvedAt,omitempty" avro:"approvedAt"`
	Assignee    *string    `mapstructure:"assignee" json:"assignee,omitempty" gorm:"column:assignee" bson:"assignee,omitempty" dynamodbav:"assignee,omitempty" firestore:"assignee,omitempty" avro:"assignee" validate:"omitempty,max=40"`
	CompletedAt *time.Time `mapstructure:"completed_at" json:"completedAt,omitempty" gorm:"column:completed_at" bson:"CompletedAt,omitempty" dynamodbav:"completedAt,omitempty" firestore:"completedAt,omitempty" avro:"completedAt"`
