...
type TicketFilter struct {
    *Filter
    ...
    RequestedAt *TimeRange `mapstructure:"requested_at" json:"requestedAt,omitempty" gorm:"column:requested_at" bson:"RequestedAt,omitempty" dynamodbav:"requestedAt,omitempty" firestore:"requestedAt,omitempty" avro:"requestedAt" validate:"required"`
    ...
    ApprovedAt *TimeRange `mapstructure:"approved_at" json:"approvedAt,omitempty" gorm:"column:approved_at" bson:"ApprovedAt,omitempty" dynamodbav:"approvedAt,omitempty" firestore:"approvedAt,omitempty" avro:"approvedAt" validate:"required"`
    ...
    CompletedAt *TimeRange `mapstructure:"completed_at" json:"completedAt,omitempty" gorm:"column:completed_at" bson:"CompletedAt,omitempty" dynamodbav:"completedAt,omitempty" firestore:"completedAt,omitempty" avro:"completedAt" validate:"required"`
