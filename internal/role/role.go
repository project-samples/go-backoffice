...
type Role struct {
	...
	Remark     *string    `json:"remark,omitempty" gorm:"column:remark" bson:"remark,omitempty" dynamodbav:"remark,omitempty" firestore:"remark,omitempty" validate:"omitempty,max=255"`
